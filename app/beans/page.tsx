...
export default function BeansPage() {
    ...
    const history = [
        ...
        },
        {
            ...
            points: "+125",
            description:
                "Blerje në dyqan: Kafe Turke Art Coffee dhe Bustine Mishele",
        },
    ];
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                    <h1 className="text-3xl font-bold mb-2">
                        Programi i Besnikërisë Beans
                    </h1>
                    <p className="text-muted-foreground text-lg">
                        Fitoni pikë për çdo blerje dhe këmbejini ato për
                        shpërblime të veçanta
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-12">
                    <Card className="md:col-span-2">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Pikët aktuale dhe progresi juaj
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardContent>
                            <ul className="space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <p className="text-sm">
                                        Fitoni 1 pikë Beans për çdo 10 Lekë të
                                        shpenzuara
                                    </p>
                                </li>
                                <li className="flex items-start">
                                    ...
                                    <p className="text-sm">
                                        Fitoni pikë shtesë për aktivitete të
                                        veçanta dhe promocione
                                    </p>
                                </li>
                                <li className="flex items-start">
                                    <div className="bg-secondary/20 p-2 rounded-full mr-3 mt-0.5">
                                    ...
                                    <p className="text-sm">
                                        Këmbeni pikët tuaja për shpërblime të
                                        ndryshme
                                    </p>
                                </li>
                                <li className="flex items-start">
                                    ...
                                    <p className="text-sm">
                                        Ngjituni në nivele më të larta për
                                        përfitime ekskluzive
                                    </p>
                                </li>
                            </ul>
                        </CardContent>
                    ...
                    <TabsContent value="history">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Aktiviteti juaj i fundit në programin Beans
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <h3 className="font-medium mb-1">
                                Si mund të fitoj pikë Beans?
                            </h3>
                            <p className="text-sm text-muted-foreground">
                                Ju fitoni 1 pikë Beans për çdo 10 Lekë të
                                shpenzuara në dyqanet tona ose në blerjet
                                online. Gjithashtu, mund të fitoni pikë shtesë
                                duke marrë pjesë në promocione të veçanta dhe
                                aktivitete.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-medium mb-1">
                                Sa kohë janë të vlefshme pikët?
                            </h3>
                            <p className="text-sm text-muted-foreground">
                                Pikët Beans janë të vlefshme për 12 muaj nga
                                data e fitimit. Pas kësaj periudhe, pikët e
                                papërdorura do të skadojnë.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-medium mb-1">
                                Si mund t'i përdor pikët e mia?
                            </h3>
                            <p className="text-sm text-muted-foreground">
                                Ju mund t'i këmbeni pikët tuaja për shpërblime
                                të ndryshme, duke përfshirë kafe falas, zbritje,
                                karta dhuratë dhe më shumë. Thjesht zgjidhni
                                shpërblimin që dëshironi dhe klikoni "Këmbe
                                Pikët".
                            </p>
                        </div>
                        <div>
                            <h3 className="font-medium mb-1">
                                A mund t'i transferoj pikët e mia te dikush
                                tjetër?
                            </h3>
                            <p className="text-sm text-muted-foreground">
                                Aktualisht, pikët Beans nuk mund të transferohen
                                te përdorues të tjerë. Ato janë të lidhura me
                                llogarinë tuaj personale.
                            </p>
                        </div>
                    </div>
                </div>
