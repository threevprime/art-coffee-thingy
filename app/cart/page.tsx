          ...
          {cartItems.length > 0 ? (
            <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <div className="p-4 flex-1">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">{item.price * item.quantity} Lekë</span>
                      </div>
                    </div>
                  </div>
                </Card>
              ...
              <Button variant="outline" className="w-full sm:w-auto">
                <Trash2 className="h-4 w-4 mr-2" /> Pastro Shportën
              </Button>
            </div>
          ) : (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-xl font-medium mb-2">Shporta juaj është bosh</h3>
                <p className="text-muted-foreground mb-6">Shtoni disa produkte në shportën tuaj</p>
        ...
        <div>
          <Card>
            ...
            <CardFooter className="text-xs text-muted-foreground text-center">
              Të gjitha çmimet përfshijnë TVSH. Dorëzimi mund të ndryshojë bazuar në vendndodhjen tuaj.
            </CardFooter>
          </Card>
        </div>
      </div>
