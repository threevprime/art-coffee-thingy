...
import { Coffee, CupSoda, Leaf, ArrowRight, ChevronLeft, ChevronRight } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[90vh] overflow-hidden">
        ...
        <div className="relative z-20 container h-full flex flex-col items-center justify-center text-center px-4">
          <div className={`mb-6 transition-opacity duration-700 ${isVisible ? "opacity-100" : "opacity-0"}`}>
            <Logo size="large" />
          </div>
          <h1
          ...
          >
            ...
            <Button asChild size="lg" variant="ghost" className="text-soft-cream hover:bg-soft-cream/10 min-w-[150px]">
      ...
      <section className="py-16 px-4">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Vizitoni Dyqanin Tonë</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Dyqani ynë është projektuar për të krijuar një ambient të ngrohtë dhe elegant, ku mund të shijoni kafen
              tuaj të preferuar në qetësi.
            </p>
          </div>
              ...
              {storeImages.map((image, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 text-center">
                    <h3 className="text-2xl font-bold text-warm-beige mb-2">{image.caption}</h3>
                  </div>
                </div>
              ))}
                ...
                {storeImages.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all ${
                      currentSlide === index ? "bg-warm-beige w-6" : "bg-white/50 hover:bg-white/80"
                    }`}
              ...
              {storeImages.map((image, index) => (
                <button
                  ...
                  className={`relative w-24 h-16 rounded-md overflow-hidden transition-all ${
                    currentSlide === index ? "ring-2 ring-warm-beige" : "opacity-70 hover:opacity-100"
                  }`}
                >
                  <Image
                    src={image.src || "/placeholder.svg"}
          ...
          <div className="text-center mt-8">
            <Button asChild className="bg-secondary text-secondary-foreground hover:bg-secondary/90">
              <Link href="/about" className="flex items-center">
                Mëso më shumë <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-muted">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Produktet Tona</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Zbuloni koleksionin tonë të plotë të kafeve të përzgjedhura me kujdes nga fermat më të mira në botë.
            </p>
          </div>
            ...
            {[
              {
                title: "Espresso",
                icon: Coffee,
                description: "Kafet tona espresso të përzgjedhura me kujdes nga fermat më të mira në botë.",
                link: "/menu?category=espresso",
              },
              {
                title: "Kafe Turke",
                icon: CupSoda,
                description: "Kafe turke tradicionale me shije autentike dhe aromë të pasur.",
                link: "/menu?category=turkish",
              },
              {
                title: "Bustine",
                icon: Leaf,
                description: "Bustina kafeje të përzgjedhura për përdorim të lehtë dhe të shpejtë.",
                link: "/menu?category=bustine",
              },
              {
                title: "Kapsula",
                icon: Coffee,
                description: "Kapsula kafeje premium për makina espresso moderne.",
                link: "/menu?category=capsules",
              },
            ].map((item, index) => {
              const Icon = item.icon
              return (
                <Card key={index} className="bg-card group hover:shadow-lg transition-all duration-300 overflow-hidden">
                  <CardContent className="p-6 flex flex-col items-center text-center relative z-10">
                    ...
                    >
                      <Link href={item.link}>Shiko Produktet</Link>
                    </Button>
                  </CardContent>
                </Card>
              )
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Produktet e Veçanta</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Zbuloni produktet tona më të dashura dhe më të shitura.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <Link key={index} href={product.link} className="block group">
                <Card className="overflow-hidden bg-card hover:shadow-xl transition-all duration-300 transform group-hover:-translate-y-2">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="font-medium text-warm-beige">{product.price}</span>
                      <Button
                        size="sm"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[400px] rounded-xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 w-full p-6">
                <p className="text-warm-beige font-medium">Dyqani ynë në Tiranë</p>
              </div>
            </div>
            <div>
              <h2 className="text-3xl font-bold mb-6">Rreth Art Coffee</h2>
              ...
              <p className="text-lg mb-6">
                Sot, Art Coffee është një destinacion për dashamirësit e kafesë që kërkojnë jo vetëm një filxhan kafe të
                shkëlqyer, por edhe një eksperiencë të plotë shqisore. Çdo detaj në dyqanin tonë është projektuar me
                kujdes për të krijuar një ambient të ngrohtë dhe elegant.
              </p>
              <Button asChild className="bg-secondary text-secondary-foreground hover:bg-secondary/90">
                <Link href="/about" className="flex items-center">
                  Mëso më shumë <ArrowRight className="ml-2 h-4 w-4" />
      ...
      <section className="py-16 px-4 bg-warm-beige text-dark-green">
        <div className="container text-center">
          <h2 className="text-3xl font-bold mb-4">Bëhuni Pjesë e Komunitetit Tonë</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Regjistrohuni në programin tonë të besnikërisë Beans dhe përfitoni nga ofertat ekskluzive, pikët e
            besnikërisë dhe më shumë.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-dark-green text-warm-beige hover:bg-dark-green/90">
