            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        <div>
                            ...
                            <p className="mb-4">
                                Për më shumë se 17 vjet, Art Coffee ka qenë
                                sinonim i cilësisë dhe shijes së shkëlqyer. Sot,
                                Art Coffee është një destinacion për
                            ...
                            <p>
                                Ne besojmë se çdo filxhan kafe është një vepër
                                arti, e krijuar me pasion dhe përkushtim. Kjo
                                filozofi udhëheq çdo aspekt të biznesit tonë,
                                nga përzgjedhja e kokrrave të kafesë deri te
                                dizajni i dyqanit tonë.
                            </p>
                        </div>
                ...
                <div className="mb-12">
                    ...
                    <p className="text-muted-foreground mb-8">
                        Dyqani ynë është projektuar për të krijuar një ambient
                        të ngrohtë dhe elegant, ku mund të shijoni kafen tuaj të
                        preferuar në qetësi. Materialet natyrore, ndriçimi i
                        butë dhe detajet e kujdesshme krijojnë një hapësirë që
                        është njëkohësisht moderne dhe mikpritëse.
                    </p>
                    ...
                    <div className="bg-card rounded-lg p-6">
                        <h3 className="text-xl font-bold mb-4">
                            Karakteristikat e Dyqanit
                        </h3>
                        <ul className="space-y-2">
                            <li className="flex items-start">
                                <span className="text-warm-beige mr-2">•</span>
                                <span>
                                    Dizajn modern me elemente druri dhe ndriçim
                                    të ngrohtë që krijon një ambient të këndshëm
                                    dhe elegant
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-warm-beige mr-2">•</span>
                                <span>
                                    Banak i gjatë prej mermeri të zi me panele
                                    druri dhe detaje prej ari
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-warm-beige mr-2">•</span>
                                <span>
                                    Rafte të ndriçuara për ekspozimin e
                                    produkteve tona të kafesë
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-warm-beige mr-2">•</span>
                                <span>
                                    Hapësirë e rehatshme për klientët për të
                                    shijuar kafen e tyre
                                </span>
                            </li>
                            <li className="flex items-start">
                                <span className="text-warm-beige mr-2">•</span>
                                <span>
                                    Pajisje moderne për përgatitjen e kafesë së
                                    cilësisë së lartë
                                </span>
                            </li>
                        </ul>
                ...
                <div className="mb-12">
                    ...
                    <p className="mb-4">
                        Në Art Coffee, ne ofrojmë një gamë të gjerë produktesh
                        kafeje të cilësisë së lartë, duke përfshirë:
                    </p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                        <Card className="bg-card">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Përzierje premium të kafeve espresso për një
                                    eksperiencë të pasur dhe të balancuar
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-card">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Kafe turke tradicionale me shije autentike
                                    dhe aromë të pasur
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-card">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Bustina kafeje të përzgjedhura për përdorim
                                    të lehtë dhe të shpejtë
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-card">
                            <CardContent className="p-6 text-center">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Kapsula kafeje premium për makina espresso
                                    moderne
                                </p>
                            </CardContent>
                        </Card>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            Rruga Myslym Shyri, Nr. 48, Tiranë,
                                            Shqipëri
                                        </p>
                                    </div>
                                </div>
