...
function CoffeeGlass({ base, milk, flavor, temperature }) {
    ...
    useEffect(() => {
        ...
        if (flavor !== "none") {
            const flavorColor = new THREE.Color(
                flavorColors[flavor] || "transparent",
            );
    ...
    return (
        <div className="container py-8">
            ...
            <p className="text-muted-foreground mb-4">
                Personalizoni kafenë tuaj sipas preferencave
            </p>
            ...
            <Tabs value={userType} onValueChange={setUserType} className="mb-6">
                ...
                <TabsContent value="personal" className="pt-4">
                    <p className="text-muted-foreground mb-4">
                        Krijoni kafenë tuaj të personalizuar për përdorim
                        personal. Zgjidhni nga opsionet tona për të krijuar
                        përzierjen perfekte për ju.
                    </p>
                </TabsContent>
                <TabsContent value="business" className="pt-4">
                    <p className="text-muted-foreground mb-4">
                        Krijoni përzierje të personalizuara për biznesin tuaj.
                        Ofrojmë çmime me shumicë dhe mundësi për të
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-between text-xs text-muted-foreground">
                                        ...
                                        <span className="flex items-center">
                                            <Flame className="h-3 w-3 mr-1" /> E
                                            nxehtë
                                        </span>
                                    </div>
                                </div>
                                ...
                                {userType === "business" && (
                                    <div className="mt-4 p-3 bg-secondary/10 rounded-md">
                                        ...
                                        <p className="text-sm text-muted-foreground">
                                            Kontaktoni për çmime speciale për
                                            porosi mbi 50 njësi
                                        </p>
                                    </div>
                                )}
